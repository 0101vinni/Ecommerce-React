                    ...
                    <Form onSubmit={handleSubmit}>
                        <Row>
                            <Form.Group className="mb-3 col-lg-6">
                                ...
                                <Form.Control name="firstName" type="text" placeholder="Primeiro Nome" required />
                            </Form.Group>
                            <Form.Group className="mb-3 col-lg-6">
                                <Form.Label>Sobrenome</Form.Label>
                                <Form.Control name="lastName" type="text" placeholder="Sobrenome" required />
                            </Form.Group>
                        </Row>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control name="username" type="text" placeholder="Usuário" minLength={3} required />
                        </Form.Group>
                        <Form.Group className="mb-3">
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control name="password" type="password" placeholder="Senha" minLength={6} required />
                        </Form.Group>
                        <Button
                            type="submit"
